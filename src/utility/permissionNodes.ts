...
> = {
  ...
  settings: [
    ...
    { node: "settings.command.server-stats", description: "/settings server-stats and /server-stats — member/deputy/boost display channels" },
    { node: "settings.command.logging", description: "/settings logging — audit forum, welcome channel, retention, invite filter" },
  ...
  mod: [
    { node: "mod.command.warn", description: "/mod warn — warn a member" },
    { node: "mod.command.kick", description: "/mod kick — kick a member" },
    { node: "mod.command.ban", description: "/mod ban — ban a member" },
    { node: "mod.command.softban", description: "/mod softban — ban, delete messages, unban" },
    { node: "mod.command.unban", description: "/mod unban — unban a user" },
    { node: "mod.command.timeout", description: "/mod timeout — timeout a member" },
    { node: "mod.command.untimeout", description: "/mod untimeout — remove a timeout" },
    { node: "mod.command.note", description: "/mod note — add a staff note" },
    { node: "mod.command.cases", description: "/mod cases — look up moderation cases" },
  ...
  vrchat: [
    ...
    { node: "vrchat.command.avatar-invite", description: "/verify avatar-invite — send avatar world invites" },
    { node: "vrchat.command.rolesync", description: "/group role-sync — sync a member's VRChat group roles" },
    { node: "vrchat.command.bulkrolesync", description: "/group bulk-role-sync — bulk VRChat group role sync" },
  ...
  dev: [
    ...
    { node: "dev.command.leaveguild", description: "/dev leave-guild — make the bot leave a guild (bot owner only)" },
