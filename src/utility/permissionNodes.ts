...
> = {
  ...
  mod: [
    ...
    { node: "mod.command.cases", description: "/mod cases|/modlogs — look up moderation cases" },
    { node: "mod.command.reason", description: "/mod reason — edit a case reason" },
    { node: "mod.command.purge", description: "/purge — bulk delete and archive messages" },
    { node: "mod.command.lock", description: "/channel lock|unlock — toggle send permissions" },
